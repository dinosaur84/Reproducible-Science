...
I think it would be easy because the code is laid out well. Separate lines are mostly used to denote new elements of the plots and annotations are provided, making each of the figures easy to edit. This could have been further facilitate by using a new line for new functions within the plot in each case.  
